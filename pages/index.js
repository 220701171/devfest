  ...
  return (
    <div className={styles.parallax}>
      <div className={props.theme ? styles.container_light : styles.container}>
        <Head>
          <title>REC Coding Club</title>
          <meta name="description" content="Official REC Coding Club Website" />
        ...
        <div>
          ...
          >
            ...
            >
              <a href="https://www.instagram.com/recdevs/" target="_blank">
                Join Us
              </a>
            </Button>
          </div>
          ...
          <Container fluid>
            <Row className={styles.tileRow}>
              <Col xs="12" sm="6" md="3" className={styles.tileContainer}>
                <Tile tileColor="blueBG" tileImage="" />
              </Col>
